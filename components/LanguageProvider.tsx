...
const translations = {
  en: {
    ...
    'pricing.starter.desc': 'Fits the under-$2,000 entry point many small businesses expect. Modern, conversion-focused, built for client acquisition.',
    'pricing.business.name': 'Business',
    'pricing.business.price': '$2,000 – $4,000',
    'pricing.business.desc': 'Contact form leads, Google visibility, multi-lingual reach. More pages, branding, and analytics so you can justify the spend with real ROI.',
    'pricing.custom.name': 'Custom',
    'pricing.custom.price': '$4,000+',
    'pricing.custom.desc': 'eCommerce, booking systems, member portals, or your first website. We build the right solution for your budget. From setup to launch, focus on growth and ROI.',
    ...
    'pricing.compare.starter.delivery': '3–4 weeks',
    ...
    'pricing.compare.business.delivery': '4–6 weeks',
    ...
    'pricing.compare.custom.delivery': '6–10 weeks',
    ...
    'services.detail.timeline.desc': 'Starter: 3–4 weeks. Business: 4–6 weeks. Premium / eCommerce: 6–10 weeks. We’ll confirm your dates before we start.',
    ...
    'faq.a1': 'Starter sites: 3–4 weeks. Business (5–7 pages): 4–6 weeks. Premium / eCommerce: 6–10 weeks. We agree on a timeline before starting.',
  ...
  es: {
    ...
    'pricing.starter.price': '1.000 – 1.800 $',
    'pricing.starter.desc': 'Encaja en el rango que muchas pequeñas empresas esperan para un primer sitio (menos de 2.000 $). Moderno, enfocado en conversión y adquisición de clientes.',
    'pricing.business.name': 'Empresarial',
    'pricing.business.price': '2.000 – 4.000 $',
    'pricing.business.desc': 'Leads por formulario, visibilidad en Google, alcance multilingüe. Más páginas, marca y analytics para que el gasto se traduzca en ROI real.',
    'pricing.custom.name': 'Personalizado',
    'pricing.custom.price': 'Desde 4.000 $',
    'pricing.custom.desc': 'eCommerce, sistemas de reservas, portales de socios o tu primer sitio web. Construimos la solución adecuada para tu presupuesto. Desde la configuración hasta el lanzamiento, enfoque en crecimiento y ROI.',
    ...
    'pricing.compare.starter.analytics': 'No',
    'pricing.compare.starter.delivery': '3–4 semanas',
    ...
    'pricing.compare.business.delivery': '4–6 semanas',
    ...
    'pricing.compare.custom.delivery': '6–10 semanas',
    ...
    'services.detail.timeline.desc': 'Básico: 3–4 semanas. Empresarial: 4–6 semanas. Premium / eCommerce: 6–10 semanas. Confirmamos fechas antes de empezar.',
    ...
    'faq.a1': 'Sitios Básico: 3–4 semanas. Empresarial (5–7 páginas): 4–6 semanas. Premium / eCommerce: 6–10 semanas. Acordamos el plazo antes de empezar.',
