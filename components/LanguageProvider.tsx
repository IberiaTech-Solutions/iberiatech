...
const translations = {
  en: {
    ...
    'pricing.starter.price': '$1,497',
    'pricing.starter.desc': 'Ideal for small companies getting online. Modern, conversion-focused, built for client acquisition.',
    'pricing.business.name': 'Business',
    'pricing.business.price': '$2,997',
    'pricing.business.desc': 'Best for growing small and medium companies. More pages, branding, and analytics for real growth and ROI.',
    'pricing.custom.name': 'Custom',
    'pricing.custom.price': 'From $3,997',
    'pricing.custom.desc': 'eCommerce, custom apps, or your first website. We build the right solution for your budget. From setup to launch, focus on growth and ROI.',
    ...
    'pricing.compare.custom.pages': 'Custom (eCommerce, booking, forms, etc.)',
    ...
    'pricing.maintenance.title': 'Ongoing support',
    'pricing.maintenance.subtitle': 'Monthly plans for updates, backups, and peace of mind.',
    'pricing.maintenance.care.name': 'Care',
    'pricing.maintenance.care.price': 'From $99/mo',
    'pricing.maintenance.care.desc': 'Updates, backups, monitoring. Keep your site secure and up to date.',
    'pricing.maintenance.growth.name': 'Growth',
    'pricing.maintenance.growth.price': 'From $199/mo',
    'pricing.maintenance.growth.desc': 'Care + content updates, SEO tweaks, and priority support.',
  ...
  es: {
    ...
    'pricing.starter.price': '1.497 $',
    'pricing.starter.desc': 'Ideal para pequeñas empresas que se estrenan en la web. Moderno, enfocado en conversión y adquisición de clientes.',
    'pricing.business.name': 'Empresarial',
    'pricing.business.price': '2.997 $',
    'pricing.business.desc': 'Ideal para pequeñas y medianas empresas en crecimiento. Más páginas, marca y analytics para crecimiento real y ROI.',
    'pricing.custom.name': 'Personalizado',
    'pricing.custom.price': 'Desde 3.997 $',
    'pricing.custom.desc': 'eCommerce, apps a medida o tu primer sitio web. Construimos la solución adecuada para tu presupuesto. Desde la configuración hasta el lanzamiento, enfoque en crecimiento y ROI.',
    ...
    'pricing.compare.custom.pages': 'A medida (eCommerce, reservas, formularios, etc.)',
    ...
    'pricing.maintenance.title': 'Soporte continuo',
    'pricing.maintenance.subtitle': 'Planes mensuales para actualizaciones, copias de seguridad y tranquilidad.',
    'pricing.maintenance.care.name': 'Cuidado',
    'pricing.maintenance.care.price': 'Desde 99 €/mes',
    'pricing.maintenance.care.desc': 'Actualizaciones, copias de seguridad, supervisión. Mantén tu sitio seguro y al día.',
    'pricing.maintenance.growth.name': 'Crecimiento',
    'pricing.maintenance.growth.price': 'Desde 199 €/mes',
    'pricing.maintenance.growth.desc': 'Cuidado + actualizaciones de contenido, ajustes SEO y soporte prioritario.',
