...
const translations = {
  en: {
    ...
    'pricing.template.name': 'Template',
    'pricing.template.desc': 'Professional website based on proven template with monthly maintenance',
    ...
    'pricing.cta.template': 'Get Template Website',
  ...
  es: {
    ...
    'pricing.template.name': 'Plantilla',
    'pricing.template.desc': 'Sitio web profesional basado en plantilla probada con mantenimiento mensual',
    ...
    'pricing.cta.template': 'Obtener Sitio con Plantilla',
