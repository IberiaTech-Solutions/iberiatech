...
const translations = {
  en: {
    ...
    'nav.contact': 'Contact',
    'hero.title': 'Websites that make small businesses look big.',
    'hero.promise': 'Affordable, bilingual sites for small businesses in Charleston and Spain — designed to convert and built to grow with you.',
  ...
  es: {
    ...
    'hero.title': 'Sitios web que hacen que tu pequeña empresa se vea grande.',
    'hero.promise': 'Sitios web bilingües y accesibles para pequeñas empresas en Charleston y España — diseñados para convertir y crecer contigo.',
