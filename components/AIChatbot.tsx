  ...
  const getCommonResponse = (message: string): string | null => {
    ...
    const responses = {
      en: {
        ...
        pricing: "We offer three packages for small and medium companies: **Starter ($1,497)** - Ideal for small companies getting online. Up to 4 pages, basic SEO, 3–4 weeks delivery, 2 rounds of revisions, English & Spanish, 1 month support. **Business ($2,997)** - Best for growing small and medium companies. Up to 7 pages, advanced SEO + Google Analytics, 4–6 weeks, 3 rounds of revisions, 3 months support. **Custom (from $3,997)** - eCommerce, custom apps, or your first website. Custom scope, 6–10 weeks, revisions included, 6 months support. All packages include free consultation and project planning. Would you like details about any specific package?",
      ...
      es: {
        ...
        pricing: "Ofrecemos tres paquetes para pequeñas y medianas empresas: **Básico (1.497 $)** - Ideal para pequeñas empresas que se estrenan en la web. Hasta 4 páginas, SEO básico, entrega en 3–4 semanas, 2 rondas de revisiones, inglés y español, 1 mes de soporte. **Empresarial (2.997 $)** - Mejor para pequeñas y medianas empresas en crecimiento. Hasta 7 páginas, SEO avanzado + Google Analytics, 4–6 semanas, 3 rondas de revisiones, 3 meses de soporte. **Personalizado (desde 3.997 $)** - eCommerce, apps a medida o tu primer sitio web. Alcance a medida, 6–10 semanas, revisiones incluidas, 6 meses de soporte. Todos los paquetes incluyen consulta gratuita y planificación. ¿Quieres detalles de algún paquete?",
